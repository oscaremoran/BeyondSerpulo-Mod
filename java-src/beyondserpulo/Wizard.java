...
public class Wizard {
    ...
    public static void init() {
        Events.on(ClientLoadEvent.class, e -> {
            ...
            } catch (Exception ex) { Log.err("[BeyondSerpulo] Wizard.init: " + ex); }
        });
        Events.on(WorldLoadEvent.class, e -> {
            ...
            } catch (Exception ex) { Log.err("[BeyondSerpulo] Wizard tour world load: " + ex); }
        });
    }
    ...
    public static void show() {
        try {
            ...
            refresh();
            dialog.show();
        } catch (Exception ex) { Log.err("[BeyondSerpulo] Wizard.show: " + ex); }
    }
    ...
    private static void refresh() {
        ...
        } catch (Exception ex) { Log.err("[BeyondSerpulo] Wizard.refresh: " + ex); }
    }
        ...
        try {
            ...
            Core.app.post(() -> {
                try {
                    ...
                    Log.err("[BeyondSerpulo] Wizard playMap: " + ex);
                    tourPending = false;
                }
            });
        } catch (Exception ex) { Log.err("[BeyondSerpulo] launchMazeAndStartTour: " + ex); }
    }
    ...
    private static void showTourStep() {
        try {
            ...
            tourOverlay = wrap;
        } catch (Exception ex) { Log.err("[BeyondSerpulo] showTourStep: " + ex); }
    }
    ...
    private static void addSettingsButton() {
        ...
        } catch (Exception ex) { Log.err("[BeyondSerpulo] Wizard settings button: " + ex); }
    }
}
