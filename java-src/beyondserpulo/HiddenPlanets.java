...
public class HiddenPlanets {
    ...
    public static void init() {
        try {
            ...
            if (hidden.isEmpty()) {
                Log.info("[BeyondSerpulo] HiddenPlanets: no vanilla planets to hide");
                return;
            }
            ...
            Log.info("[BeyondSerpulo] HiddenPlanets: hid " + hidden.size + " planets, scrubbed " + scrubbed + " tab refs");
        } catch (Exception e) {
            Log.err("[BeyondSerpulo] HiddenPlanets.init: " + e);
        }
    }
}
