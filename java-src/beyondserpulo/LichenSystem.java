...
public class LichenSystem {
    ...
    private static void purgeStrayLichen() {
        try {
            ...
            Log.info("[BeyondSerpulo] WorldLoad: sector-planet=" + sName + " rules-planet=" + pName + " lichenPlanet=" + isLichenPlanet());
            ...
            if (purged > 0) Log.info("[BeyondSerpulo] Purged " + purged + " stray lichen tiles on " + n);
