...
public class Codex {
    ...
    public static void show() {
        try { if (dialog != null) dialog.show(); } catch (Exception ex) { Log.err("[BeyondSerpulo] codex show: " + ex); }
    }

    private static void setup() {
        try {
            Log.info("[BeyondSerpulo] codex setup starting");
            buildDialog();
            ...
            try {
                ...
                if (game != null) {
                    ...
                    Log.info("[BeyondSerpulo] codex clear button added to settings game tab");
                }
            } catch (Exception ex) { Log.err("[BeyondSerpulo] settings codex clear setup: " + ex); }
        } catch (Exception ex) {
            Log.err("[BeyondSerpulo] codex setup: " + ex);
        }
    }
