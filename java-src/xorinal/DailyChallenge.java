...
public class DailyChallenge {
    ...
    public static Map todayMap() {
        ...
        try {
            ...
            return null;
        } catch (Exception ex) { Log.err("[Xorinal] DailyChallenge.todayMap: " + ex); return null; }
    }
    ...
    public static void init() {
        ...
        Events.on(GameOverEvent.class, e -> {
            Log.info("[Xorinal] GameOverEvent fired; active=" + active + " wave=" + Vars.state.wave);
            if (!active) return;
        ...
        Events.on(WorldLoadEvent.class, e -> {
            Log.info("[Xorinal] WorldLoadEvent; active=" + active + " state.map=" + (Vars.state.map==null?"null":Vars.state.map.name()) + " today=" + today().mapName);
